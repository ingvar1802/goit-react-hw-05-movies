...
const MovieCastView = lazy(() => import('../MovieCast/MovieCastView' /* webpackChunkName: "MovieCastView" */),);
...
const MovieDetailedView = () => {
  ...
  return (
    <>
      {movie && (
        <>
          <button type="button" className={s.button} onClick={onGoBack}>GoBack</button>
          <div>
